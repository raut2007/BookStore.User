...
namespace BookStore.User.Api.Repository
{
    public class UserList
    {
            ...
            { 
                ...
                new UserModel { Id = 103,FirstName = "A1", LastName="A11", IsActive = true, IsDeleted=false, CreatedBy = 1, CreatedDate = DateTime.Now, UpdatedBy = 1, UpdatedDate = DateTime.Now },
            };
    }
}
